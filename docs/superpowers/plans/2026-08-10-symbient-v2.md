...
- [ ] **Step 3: Regenerate everything generated**
...
```bash
git add data/skills-matrix.yaml federation.yaml SKILLS.md .well-known/ docs/QUILT.md CHANGELOG.md DECISIONS.md
...
5. Commit only `.gitignore` + `archive/` changes. Nothing under `symbient/` is ever staged.
