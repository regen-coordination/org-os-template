...
> **Release status (2026-08-28):** Shipped (skills/symbient/, scripts/symbient-hatch.mjs on main); CHANGELOG fold into [0.5.0] happens in the masterplan. Convergence: [v0.5 release masterplan](2026-08-28-v0.5-release-masterplan.md).
