...
> **Release status (2026-08-28):** Deferred to v0.6+ — portfolio memo §4 row 13; 21 unmerged commits preserved (archive tag per masterplan WS-E); gets its first QUEUE (Scoping) line for visibility. Convergence: [v0.5 release masterplan](2026-08-28-v0.5-release-masterplan.md).
