...
1. **org-os-website** — **Design-approved 2026-06-17** (brainstorm + visual companion). org-os v0.5 public framework website + docs site at `org-os/site/` (Astro 5, static). Presents the framework + v0.5 module roadmap, renders curated docs from `../docs` (single source of truth, content-collection `glob()` loader), and federates live-at-build from `data/instances.yaml` + sibling instance `.well-known/`+`data/`. Light "systems" theme (Geist Mono, hairline grid, federation graph) in a token/theme-swap architecture — the reusable core is the seam toward `org-os-website-generator`. Spec: [`2026-06-17-org-os-website-design.md`](../superpowers/specs/2026-06-17-org-os-website-design.md) · 15-task plan: [`2026-06-17-org-os-website.md`](../superpowers/plans/2026-06-17-org-os-website.md) · workstream: public-surfaces · ready to execute
