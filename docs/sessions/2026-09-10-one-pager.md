...
> shared operating system for a federation of regenerative organizations
...
**Live:** <https://regen-coordination.github.io/org-os-template/> · **Version:** 0.5.0 (pre-beta by
design — renumbered *down* from 3.5 to say so honestly) · self-hosting since
2026-04-24.

**By the numbers (0.5.0):** 35 agent skills ·
