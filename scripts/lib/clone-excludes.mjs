...
export const TOP_LEVEL_DENY = new Map([
  ...
  ["AGENTS.md", "calls itself the upstream framework — rendered from templates/AGENTS.instance.md in stage 7"],
  ...
  ["dashboard.yaml", "tuned for the framework hub role (custom sections read stripped registries) — neutral instance version written in stage 4b"],
...
export const GENERATED_FILES = new Set([
  ...
  "federation.yaml", "README.md", "GETTING-STARTED.md", "CLAUDE.md", "AGENTS.md",
  "dashboard.yaml",
